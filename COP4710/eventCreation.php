          ...
          <form action="" method="post">
           <div class="container">
              ...
              <div class="row col-full">
               <input type="date" class="form-textbox" placeholder="Start Date" name="date" required>
               <div class="underline"></div>
              </div>
			  <div class="row col-full">
               <input type="time" class="form-textbox" placeholder="Start Time" name="time" required>
               <div class="underline"></div>
              </div>
			  <div class="row col-full">
